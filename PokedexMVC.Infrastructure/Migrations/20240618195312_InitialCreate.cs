        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movesets_Pokemons_PokemonRef",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PokemonRef = table.Column<int>(type: "int", nullable: false),
                    AbilityRef = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemonAbility", x => new { x.PokemonRef, x.AbilityRef });
                    table.ForeignKey(
                        name: "FK_PokemonAbility_Abilities_AbilityRef",
                        column: x => x.AbilityRef,
                        principalTable: "Abilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PokemonAbility_Pokemons_PokemonRef",
                        column: x => x.PokemonRef,
                        principalTable: "Pokemons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemonDescriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PokemonDescriptions_Pokemons_PokemonRef",
                        column: x => x.PokemonRef,
                        principalTable: "Pokemons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Statistics_Pokemons_PokemonRef",
                        column: x => x.PokemonRef,
                        principalTable: "Pokemons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPhisical = table.Column<bool>(type: "bit", nullable: false),
                    Damage = table.Column<int>(type: "int", nullable: false),
                    EffectId = table.Column<int>(type: "int", nullable: true),
                    MovesetId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Moves_Movesets_MovesetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movesets_PokemonRef",
                table: "Movesets",
                column: "PokemonRef",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PokemonAbility_AbilityRef",
                table: "PokemonAbility",
                column: "AbilityRef");

            migrationBuilder.CreateIndex(
                name: "IX_PokemonDescriptions_PokemonRef",
